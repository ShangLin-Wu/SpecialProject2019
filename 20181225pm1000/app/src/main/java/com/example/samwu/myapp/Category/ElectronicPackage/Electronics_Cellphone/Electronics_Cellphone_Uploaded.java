...
public class Electronics_Cellphone_Uploaded extends AppCompatActivity implements Electronics_Cellphone_ListAdapter.OnItemClickListener{

    CollectionReference mDBPath;
    FirebaseFirestore mDB = FirebaseFirestore.getInstance();

    private List<getUploadedProductsData> getUploadedProductsDataList;
    private Electronics_Cellphone_ListAdapter ClothesCellphoneAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electronics__cellphone);

        getUploadedProductsDataList = new ArrayList<>();

        ClothesCellphoneAdapter = new Electronics_Cellphone_ListAdapter(getUploadedProductsDataList);
        ...
        firebaseUserSearch();
        mResultList.setAdapter(ClothesCellphoneAdapter);
        ClothesCellphoneAdapter.setOnItemClickListener(Electronics_Cellphone_Uploaded.this);
        UIUtil.hideKeyboard(Electronics_Cellphone_Uploaded.this);
    ...
    private void firebaseUserSearch() {
        ...
        searchText = "ElectronicsProducts/Cellphone";
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                mDBPath.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@android.support.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @android.support.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        ClothesCellphoneAdapter.notifyDataSetChanged();
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(this, Electronics_Cellphone_Page.class);
    ...
    public void clickback(View view) {
        Intent clickback= new Intent(this, category3C.class);
