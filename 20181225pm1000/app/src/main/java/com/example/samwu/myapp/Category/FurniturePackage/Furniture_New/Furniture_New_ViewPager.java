...
public class Furniture_New_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    Furniture_New_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new Furniture_New_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,Furniture_New_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(Furniture_New_ViewPager.this);
