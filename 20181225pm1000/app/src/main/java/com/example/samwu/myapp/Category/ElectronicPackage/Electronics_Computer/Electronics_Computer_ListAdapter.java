...
public class Electronics_Computer_ListAdapter extends RecyclerView.Adapter<Electronics_Computer_ListAdapter.ViewHolder>{

    private Electronics_Computer_ListAdapter.OnItemClickListener listener;

    public List<getUploadedProductsData> getUploadedProductsData;

    public Electronics_Computer_ListAdapter(List<getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;

    }

    public Electronics_Computer_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Electronics_Computer_ListAdapter.ViewHolder(view);
    }
