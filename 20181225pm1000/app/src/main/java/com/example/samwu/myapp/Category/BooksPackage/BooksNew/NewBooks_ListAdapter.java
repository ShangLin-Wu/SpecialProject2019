...
public class NewBooks_ListAdapter extends RecyclerView.Adapter<NewBooks_ListAdapter.ViewHolder>{

    private NewBooks_ListAdapter.OnItemClickListener listener;

    public List<getUploadedProductsData> getUploadedProductsData;

    public NewBooks_ListAdapter(List<getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;

    }

    public NewBooks_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new NewBooks_ListAdapter.ViewHolder(view);
    }
