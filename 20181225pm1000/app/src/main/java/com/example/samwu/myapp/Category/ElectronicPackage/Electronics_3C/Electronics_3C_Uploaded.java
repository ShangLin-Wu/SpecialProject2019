...
public class Electronics_3C_Uploaded extends AppCompatActivity implements Electronics_3C_ListAdapter.OnItemClickListener {

    CollectionReference mDBPath;
    FirebaseFirestore mDB = FirebaseFirestore.getInstance();

    private List<getUploadedProductsData> getUploadedProductsDataList;
    private Electronics_3C_ListAdapter Clothes3CAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eletronics_3c);

        getUploadedProductsDataList = new ArrayList<>();

        Clothes3CAdapter = new Electronics_3C_ListAdapter(getUploadedProductsDataList);
        ...
        firebaseUserSearch();
        mResultList.setAdapter(Clothes3CAdapter);
        Clothes3CAdapter.setOnItemClickListener(Electronics_3C_Uploaded.this);
        UIUtil.hideKeyboard(Electronics_3C_Uploaded.this);
    ...
    private void firebaseUserSearch() {
        ...
        searchText = "ElectronicsProducts/3C";
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                mDBPath.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@android.support.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @android.support.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        Clothes3CAdapter.notifyDataSetChanged();
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(this, Electronics_3C_Page.class);
