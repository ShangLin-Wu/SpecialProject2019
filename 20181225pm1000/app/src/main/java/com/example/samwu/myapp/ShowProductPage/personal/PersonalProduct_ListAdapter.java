...
public class PersonalProduct_ListAdapter extends RecyclerView.Adapter<PersonalProduct_ListAdapter.ViewHolder>{

    private PersonalProduct_ListAdapter.OnItemClickListener listener;

    public List<com.example.samwu.myapp.Model.getUploadedProductsData> getUploadedProductsData;

    public PersonalProduct_ListAdapter(List<com.example.samwu.myapp.Model.getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;

    }

    public PersonalProduct_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PersonalProduct_ListAdapter.ViewHolder(view);
    }
