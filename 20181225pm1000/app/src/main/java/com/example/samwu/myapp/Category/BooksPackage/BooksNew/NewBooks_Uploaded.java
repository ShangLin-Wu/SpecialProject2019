...
public class NewBooks_Uploaded extends AppCompatActivity implements NewBooks_ListAdapter.OnItemClickListener {
    ...
    private NewBooks_ListAdapter NewBooksListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newbooks_uploaded);

        getUploadedProductsDataList = new ArrayList<>();

        NewBooksListAdapter = new NewBooks_ListAdapter(getUploadedProductsDataList);
        ...
        firebaseUserSearch();
        mResultList.setAdapter(NewBooksListAdapter);
        NewBooksListAdapter.setOnItemClickListener(NewBooks_Uploaded.this);
        UIUtil.hideKeyboard(NewBooks_Uploaded.this);
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                mDBPath.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@android.support.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @android.support.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        NewBooksListAdapter.notifyDataSetChanged();
    ...
    public void onItemClick(int position) {
        ...
        Log.d("CLoick", "*******");
        Intent intent = new Intent(this, NewBooks_Page.class);
