...
public class UsedBooks_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    UsedBooks_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new UsedBooks_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,UsedBooks_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(UsedBooks_ViewPager.this);
