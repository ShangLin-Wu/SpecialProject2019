...
import com.example.samwu.myapp.ShowProductPage.search.SearchViewpager;

public class AllViewPager extends AppCompatActivity {

    ViewPager viewPager;
    AllProductSwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new AllProductSwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,AllProductPage.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(AllViewPager.this);
