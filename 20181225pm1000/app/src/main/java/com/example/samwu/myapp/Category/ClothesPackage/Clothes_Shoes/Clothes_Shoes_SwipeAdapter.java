...
public class Clothes_Shoes_SwipeAdapter extends PagerAdapter {

    private Context ctx;
    private LayoutInflater layoutInflater;
    Clothes_Shoes_ViewPager s=new Clothes_Shoes_ViewPager();

    String[] image_resorces = new String[6];

    public Clothes_Shoes_SwipeAdapter(Context ctx)
    {
