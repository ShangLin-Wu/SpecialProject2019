...
public class Clothes_Shirts_SwipeAdapter extends PagerAdapter {

    private Context ctx;
    private LayoutInflater layoutInflater;
    Clothes_Shirts_ViewPager s=new Clothes_Shirts_ViewPager();

    String[] image_resorces = new String[6];

    public Clothes_Shirts_SwipeAdapter(Context ctx)
    {
