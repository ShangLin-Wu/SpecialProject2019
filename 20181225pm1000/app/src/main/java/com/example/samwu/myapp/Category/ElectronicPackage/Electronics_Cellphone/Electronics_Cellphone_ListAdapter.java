...
public class Electronics_Cellphone_ListAdapter extends RecyclerView.Adapter<Electronics_Cellphone_ListAdapter.ViewHolder>{

    private Electronics_Cellphone_ListAdapter.OnItemClickListener listener;

    public List<getUploadedProductsData> getUploadedProductsData;

    public Electronics_Cellphone_ListAdapter(List<getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;

    }

    public Electronics_Cellphone_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Electronics_Cellphone_ListAdapter.ViewHolder(view);
    }
