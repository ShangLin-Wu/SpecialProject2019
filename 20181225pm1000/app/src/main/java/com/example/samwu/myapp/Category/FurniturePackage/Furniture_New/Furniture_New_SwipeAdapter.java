...
public class Furniture_New_SwipeAdapter extends PagerAdapter {

    private Context ctx;
    private LayoutInflater layoutInflater;
    Furniture_New_ViewPager s=new Furniture_New_ViewPager();

    String[] image_resorces = new String[6];

    public Furniture_New_SwipeAdapter(Context ctx)
    {
