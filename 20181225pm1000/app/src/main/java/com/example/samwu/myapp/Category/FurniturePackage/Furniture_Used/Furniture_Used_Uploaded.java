...
public class Furniture_Used_Uploaded extends AppCompatActivity implements Furniture_Used_ListAdapter.OnItemClickListener{

    CollectionReference mDBPath;
    FirebaseFirestore mDB = FirebaseFirestore.getInstance();

    private List<getUploadedProductsData> getUploadedProductsDataList;
    private Furniture_Used_ListAdapter FurnitureUsedListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_furniture__used);

        getUploadedProductsDataList = new ArrayList<>();

        FurnitureUsedListAdapter = new Furniture_Used_ListAdapter(getUploadedProductsDataList);
        ...
        firebaseUserSearch();
        mResultList.setAdapter(FurnitureUsedListAdapter);
        FurnitureUsedListAdapter.setOnItemClickListener(Furniture_Used_Uploaded.this);
        UIUtil.hideKeyboard(Furniture_Used_Uploaded.this);
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                mDBPath.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@android.support.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @android.support.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        FurnitureUsedListAdapter.notifyDataSetChanged();
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(this, Furniture_Used_Page.class);
    ...
    public void clickback(View view) {
        Intent clickback= new Intent(this, categoryFurniture.class);
