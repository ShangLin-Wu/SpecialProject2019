...
public class Electronics_Computer_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    Electronics_Computer_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new Electronics_Computer_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,Electronics_Computer_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(Electronics_Computer_ViewPager.this);
