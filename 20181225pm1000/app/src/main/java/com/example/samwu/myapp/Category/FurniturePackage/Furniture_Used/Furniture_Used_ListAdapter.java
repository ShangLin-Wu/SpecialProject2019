...
public class Furniture_Used_ListAdapter extends RecyclerView.Adapter<Furniture_Used_ListAdapter.ViewHolder>{

    private Furniture_Used_ListAdapter.OnItemClickListener listener;

    public List<getUploadedProductsData> getUploadedProductsData;

    public Furniture_Used_ListAdapter(List<getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;

    }

    public Furniture_Used_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Furniture_Used_ListAdapter.ViewHolder(view);
    }
