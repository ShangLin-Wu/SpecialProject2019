...
public class Clothes_Shoes_ListAdapter extends RecyclerView.Adapter<Clothes_Shoes_ListAdapter.ViewHolder>{

    private Clothes_Shoes_ListAdapter.OnItemClickListener listener;

    public List<getUploadedProductsData> getUploadedProductsData;

    public Clothes_Shoes_ListAdapter(List<getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;

    }

    public Clothes_Shoes_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Clothes_Shoes_ListAdapter.ViewHolder(view);
    }
