...
public class UsedBooks_ListAdapter extends RecyclerView.Adapter<UsedBooks_ListAdapter.ViewHolder>{

    private UsedBooks_ListAdapter.OnItemClickListener listener;

    public List<com.example.samwu.myapp.Model.getUploadedProductsData> getUploadedProductsData;

    public UsedBooks_ListAdapter(List<getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;


    }

    public UsedBooks_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UsedBooks_ListAdapter.ViewHolder(view);
    }
