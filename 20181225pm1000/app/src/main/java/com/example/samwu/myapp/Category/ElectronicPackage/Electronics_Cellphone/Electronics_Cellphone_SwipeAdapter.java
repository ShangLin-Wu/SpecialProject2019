...
public class Electronics_Cellphone_SwipeAdapter extends PagerAdapter {

    private Context ctx;
    private LayoutInflater layoutInflater;
    Electronics_Cellphone_ViewPager s=new Electronics_Cellphone_ViewPager();

    String[] image_resorces = new String[6];

    public Electronics_Cellphone_SwipeAdapter(Context ctx)
    {
