...
public class Electronics_Computer_SwipeAdapter extends PagerAdapter {

    private Context ctx;
    private LayoutInflater layoutInflater;
    Electronics_Computer_ViewPager s=new Electronics_Computer_ViewPager();

    String[] image_resorces = new String[6];

    public Electronics_Computer_SwipeAdapter(Context ctx)
    {
