...
public class UsedBooks_Uploaded extends AppCompatActivity implements UsedBooks_ListAdapter.OnItemClickListener {
    ...
    private UsedBooks_ListAdapter UsedBooksListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usedbooks_uploaded);

        getUploadedProductsDataList = new ArrayList<>();

        UsedBooksListAdapter = new UsedBooks_ListAdapter(getUploadedProductsDataList);
        ...
        firebaseUserSearch();
        mResultList.setAdapter(UsedBooksListAdapter);
        UsedBooksListAdapter.setOnItemClickListener(UsedBooks_Uploaded.this);
        UIUtil.hideKeyboard(UsedBooks_Uploaded.this);
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                mDBPath.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@android.support.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @android.support.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        UsedBooksListAdapter.notifyDataSetChanged();
    ...
    public void clickback(View view) {
        Intent clickback = new Intent(this, categoryBooks.class);
    ...
    public void onItemClick(int position) {
        ...
        Log.d("CLoick", "*******");
        Intent intent = new Intent(this, UsedBooks_Page.class);
