...
public class Electronics_Cellphone_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    Electronics_Cellphone_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new Electronics_Cellphone_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,Electronics_Cellphone_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(Electronics_Cellphone_ViewPager.this);
