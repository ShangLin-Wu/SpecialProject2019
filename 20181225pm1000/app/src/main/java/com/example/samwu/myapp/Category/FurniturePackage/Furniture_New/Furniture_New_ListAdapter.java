...
public class Furniture_New_ListAdapter extends RecyclerView.Adapter<Furniture_New_ListAdapter.ViewHolder>{

    private Furniture_New_ListAdapter.OnItemClickListener listener;

    public List<getUploadedProductsData> getUploadedProductsData;

    public Furniture_New_ListAdapter(List<getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;

    }

    public Furniture_New_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Furniture_New_ListAdapter.ViewHolder(view);
    }
