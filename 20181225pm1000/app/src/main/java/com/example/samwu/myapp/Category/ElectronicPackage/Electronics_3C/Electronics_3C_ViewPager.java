...
public class Electronics_3C_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    Electronics_3C_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new Electronics_3C_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,Electronics_3C_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(Electronics_3C_ViewPager.this);
