package com.example.samwu.myapp.Category.ClothesPackage.Clothes_Shoes;
...
import com.example.samwu.myapp.Category.ClothesPackage.Clothes_Pants.Clothes_Pants_detailpage;
...
import com.example.samwu.myapp.Category.ClothesPackage.Clothes_Pants.Clothes_Pants_ViewPager;
...
public class Clothes_Shoes_Page extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mDBProfileimg.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                Picasso.with(Clothes_Shoes_Page.this).load(ProfileImgPath).fit().centerInside().into(prod_image);
            }
        ...
        IntentToViewpager = new Intent(this, Clothes_Pants_ViewPager.class);
    ...
    private void addfavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(Clothes_Shoes_Page.this, "已加入我的最愛", Toast.LENGTH_LONG).show();
    ...
    private void removefavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(Clothes_Shoes_Page.this, "已移除", Toast.LENGTH_LONG).show();
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    if (!mAuth.getEmail().equals(s)) {
                        ...
                        Intent intent = new Intent(Clothes_Shoes_Page.this, MessageActivity.class);
...
//---ShowBtn
    ...
    {
        Intent detailpage = new Intent(this, Clothes_Shoes_detailpage.class);
    ...
    public void clickback(View view) {
        Intent clickback = new Intent(this, Clothes_Shoes_Uploaded.class);
