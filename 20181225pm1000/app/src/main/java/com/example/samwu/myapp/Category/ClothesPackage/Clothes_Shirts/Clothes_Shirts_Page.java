...
public class Clothes_Shirts_Page extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mDBProfileimg.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                Picasso.with(Clothes_Shirts_Page.this).load(ProfileImgPath).fit().centerInside().into(prod_image);
            }
    ...
    private void addfavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(Clothes_Shirts_Page.this, "已加入我的最愛", Toast.LENGTH_LONG).show();
    ...
    private void removefavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(Clothes_Shirts_Page.this, "已移除", Toast.LENGTH_LONG).show();
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    if (!mAuth.getEmail().equals(s)) {
                        ...
                        Intent intent = new Intent(Clothes_Shirts_Page.this, MessageActivity.class);
...
//---ShowBtn
    ...
    {
        Intent detailpage = new Intent(this, Clothes_Shirts_detailpage.class);
