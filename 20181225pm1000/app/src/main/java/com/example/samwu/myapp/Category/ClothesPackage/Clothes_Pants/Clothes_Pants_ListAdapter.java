...
public class Clothes_Pants_ListAdapter extends RecyclerView.Adapter<Clothes_Pants_ListAdapter.ViewHolder>{

    private Clothes_Pants_ListAdapter.OnItemClickListener listener;

    public List<getUploadedProductsData> getUploadedProductsData;

    public Clothes_Pants_ListAdapter(List<getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;

    }

    public Clothes_Pants_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Clothes_Pants_ListAdapter.ViewHolder(view);
    }
