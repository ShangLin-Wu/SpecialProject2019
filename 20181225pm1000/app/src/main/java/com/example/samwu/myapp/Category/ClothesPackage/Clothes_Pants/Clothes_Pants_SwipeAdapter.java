...
public class Clothes_Pants_SwipeAdapter extends PagerAdapter {

    private Context ctx;
    private LayoutInflater layoutInflater;
    Clothes_Pants_ViewPager s=new Clothes_Pants_ViewPager();

    String[] image_resorces = new String[6];

    public Clothes_Pants_SwipeAdapter(Context ctx)
    {
