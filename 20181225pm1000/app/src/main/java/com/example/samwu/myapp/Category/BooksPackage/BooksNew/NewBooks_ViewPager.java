...
public class NewBooks_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    NewBooks_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new NewBooks_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,NewBooks_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(NewBooks_ViewPager.this);
