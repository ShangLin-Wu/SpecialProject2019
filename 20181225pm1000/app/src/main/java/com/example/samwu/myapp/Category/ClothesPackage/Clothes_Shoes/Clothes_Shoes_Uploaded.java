...
public class Clothes_Shoes_Uploaded extends AppCompatActivity implements Clothes_Shoes_ListAdapter.OnItemClickListener {

    CollectionReference mDBPath;
    FirebaseFirestore mDB = FirebaseFirestore.getInstance();

    private List<getUploadedProductsData> getUploadedProductsDataList;
    private Clothes_Shoes_ListAdapter ClothesShoesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clothes__shoes_uploaded);

        getUploadedProductsDataList = new ArrayList<>();

        ClothesShoesAdapter = new Clothes_Shoes_ListAdapter(getUploadedProductsDataList);
        ...
        firebaseUserSearch();
        mResultList.setAdapter(ClothesShoesAdapter);
        ClothesShoesAdapter.setOnItemClickListener(Clothes_Shoes_Uploaded.this);
        UIUtil.hideKeyboard(Clothes_Shoes_Uploaded.this);
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                mDBPath.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@android.support.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @android.support.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        ClothesShoesAdapter.notifyDataSetChanged();
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(this, Clothes_Shoes_Page.class);
