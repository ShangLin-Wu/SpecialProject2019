...
public class PersonalProduct_SwipeAdapter extends PagerAdapter {

    private Context ctx;
    private LayoutInflater layoutInflater;
    PersonalProduct_ViewPager s=new PersonalProduct_ViewPager();

    String[] image_resorces = new String[6];

    public PersonalProduct_SwipeAdapter(Context ctx)
    {
