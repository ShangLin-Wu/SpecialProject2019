...
public class Electronics_3C_SwipeAdapter extends PagerAdapter {

    private Context ctx;
    private LayoutInflater layoutInflater;
    Electronics_3C_ViewPager s=new Electronics_3C_ViewPager();

    String[] image_resorces = new String[6];

    public Electronics_3C_SwipeAdapter(Context ctx)
    {
