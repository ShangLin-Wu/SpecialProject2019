...
public class Furniture_New_Uploaded extends AppCompatActivity implements Furniture_New_ListAdapter.OnItemClickListener {

    CollectionReference mDBPath;
    FirebaseFirestore mDB = FirebaseFirestore.getInstance();

    private List<getUploadedProductsData> getUploadedProductsDataList;
    private Furniture_New_ListAdapter FurnitureNewListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_furniture__new);

        getUploadedProductsDataList = new ArrayList<>();

        FurnitureNewListAdapter = new Furniture_New_ListAdapter(getUploadedProductsDataList);
        ...
        firebaseUserSearch();
        mResultList.setAdapter(FurnitureNewListAdapter);
        FurnitureNewListAdapter.setOnItemClickListener(Furniture_New_Uploaded.this);
        UIUtil.hideKeyboard(Furniture_New_Uploaded.this);
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                mDBPath.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@android.support.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @android.support.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        FurnitureNewListAdapter.notifyDataSetChanged();
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(this, Furniture_New_Page.class);
