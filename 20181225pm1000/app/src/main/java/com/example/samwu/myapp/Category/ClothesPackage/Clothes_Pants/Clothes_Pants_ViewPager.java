...
public class Clothes_Pants_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    Clothes_Pants_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new Clothes_Pants_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,Clothes_Pants_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(Clothes_Pants_ViewPager.this);
