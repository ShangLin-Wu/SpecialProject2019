...
public class Clothes_Pants_detailpage extends AppCompatActivity {
    ...
    {
        Intent detailpage = new Intent(this, Clothes_Pants_Page.class);
    ...
    public void clickback(View view) {
        Intent clickback = new Intent(this, Clothes_Pants_Uploaded.class);
