...
public class AllProductPage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final Intent W=new Intent(this,AllProduct_detailpage.class);
        ...
        mDBProfileimg.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                Picasso.with(AllProductPage.this).load(ProfileImgPath).fit().centerInside().into(prod_image);
            }
    ...
    private void removefavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(AllProductPage.this, "已移除", Toast.LENGTH_LONG).show();
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    if (!mAuth.getEmail().equals(s)) {
                        ...
                        Intent intent =new Intent(AllProductPage.this, MessageActivity.class);
...
//---ShowBtn
    ...
    {
        Intent detailpage = new Intent(this, AllProduct_detailpage.class);
