...
public class Clothes_Shirts_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    Clothes_Shirts_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new Clothes_Shirts_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,Clothes_Shirts_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(Clothes_Shirts_ViewPager.this);
