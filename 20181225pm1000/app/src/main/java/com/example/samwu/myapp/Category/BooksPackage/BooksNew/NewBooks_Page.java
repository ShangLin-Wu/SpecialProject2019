...
public class NewBooks_Page extends AppCompatActivity implements View.OnClickListener {
...
//---
        ...
        final Intent W=new Intent(this,NewBooks_detailpage.class);
...
//***
        ...
        */
        ...
        mDBProfileimg.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                Picasso.with(NewBooks_Page.this).load(ProfileImgPath).fit().centerInside().into(prod_image);
            }
        ...
        */
        ...
        IntentToViewpager = new Intent(this, NewBooks_ViewPager.class);
    ...
    private void addfavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(NewBooks_Page.this, "已加入我的最愛", Toast.LENGTH_LONG).show();
    ...
    private void removefavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(NewBooks_Page.this, "已移除", Toast.LENGTH_LONG).show();
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    if (!mAuth.getEmail().equals(s)) {
                        ...
                        Intent intent = new Intent(NewBooks_Page.this, MessageActivity.class);
