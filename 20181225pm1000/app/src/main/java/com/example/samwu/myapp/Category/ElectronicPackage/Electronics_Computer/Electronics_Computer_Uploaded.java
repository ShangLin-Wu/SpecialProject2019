...
public class Electronics_Computer_Uploaded extends AppCompatActivity implements Electronics_Computer_ListAdapter.OnItemClickListener {

    CollectionReference mDBPath;
    FirebaseFirestore mDB = FirebaseFirestore.getInstance();

    private List<getUploadedProductsData> getUploadedProductsDataList;
    private Electronics_Computer_ListAdapter ClothesComputerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electronics__coumputer);

        getUploadedProductsDataList = new ArrayList<>();

        ClothesComputerAdapter = new Electronics_Computer_ListAdapter(getUploadedProductsDataList);
        ...
        firebaseUserSearch();
        mResultList.setAdapter(ClothesComputerAdapter);
        ClothesComputerAdapter.setOnItemClickListener(Electronics_Computer_Uploaded.this);
        UIUtil.hideKeyboard(Electronics_Computer_Uploaded.this);
    ...
    private void firebaseUserSearch() {
        ...
        searchText = "ElectronicsProducts/Computer";
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                mDBPath.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@android.support.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @android.support.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        ClothesComputerAdapter.notifyDataSetChanged();
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(this, Electronics_Computer_Page.class);
