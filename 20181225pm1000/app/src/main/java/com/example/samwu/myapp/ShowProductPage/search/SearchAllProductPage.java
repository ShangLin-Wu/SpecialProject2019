...
import com.example.samwu.myapp.ShowProductPage.personal.PersonalProduct_Page;
...
public class SearchAllProductPage extends AppCompatActivity implements View.OnClickListener  {
...
//**for showbtn
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent W=new Intent(this,SearchProduct_detailpage.class);
        ...
        String uploadtime = intent.getStringExtra("uploadtime");
        String classify = intent.getStringExtra("classify");
        String productPath = intent.getStringExtra("productPath");
        String userProfilesPath = intent.getStringExtra("userProfilesPath");

        */


        //all of data
        String YY= String.valueOf(intent.getExtras());
        Log.d("AllOfData",YY);
...
//get uploader profile image
        mDBPath=mDB.collection("UserProfiles").document(email).collection("ProfileInfo").document("X");
        mDBPath.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                String ProfileImgPath=  documentSnapshot.getData().get("profileimg").toString();
                Picasso.with(SearchAllProductPage.this).load(ProfileImgPath).into(prod_image);
                Log.d("ProfileImgPath",ProfileImgPath);
            }
        });
//get uploader profile image
        ...
        /*
        IntentToViewpager.putExtra("a", a);
        IntentToViewpager.putExtra("b", b);
        IntentToViewpager.putExtra("c", c);
        IntentToViewpager.putExtra("d", d);
        IntentToViewpager.putExtra("e", e);
        IntentToViewpager.putExtra("f", f);
        IntentToViewpager.putExtra("producttitle", producttitle);
        IntentToViewpager.putExtra("email", email);
        IntentToViewpager.putExtra("details", details);
        IntentToViewpager.putExtra("phone", phone);
        IntentToViewpager.putExtra("uploadtime", uploadtime);
        IntentToViewpager.putExtra("classify", classify);
        IntentToViewpager.putExtra("productPath", productPath);
        IntentToViewpager.putExtra("userProfilesPath", userProfilesPath);
        */


        IntentToViewpager = new Intent(this, SearchViewpager.class);
    ...
    private void addfavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(SearchAllProductPage.this, "已加入我的最愛", Toast.LENGTH_LONG).show();


            }
        });
/*
        favoriteDocumentRef.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                Toast.makeText(AllProductPage.this,"已加入我的最愛",Toast.LENGTH_LONG).show();
                Log.d("favorite : ", String.valueOf(favorite_switch));
    ...
    private void removefavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(SearchAllProductPage.this, "已移除", Toast.LENGTH_LONG).show();
            }
        });
    }
//---favorite btn
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    if (!mAuth.getEmail().equals(s)) {
                        ...
                        Intent intent =new Intent(SearchAllProductPage.this, MessageActivity.class);
    ...
    {
        Intent detailpage = new Intent(this, SearchProduct_detailpage.class);
    ...
    public void clickback(View view) {
        Intent clickback= new Intent(this, cloudSearch.class);
