...
public class Furniture_Used_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    Furniture_Used_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new Furniture_Used_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,Furniture_Used_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(Furniture_Used_ViewPager.this);
