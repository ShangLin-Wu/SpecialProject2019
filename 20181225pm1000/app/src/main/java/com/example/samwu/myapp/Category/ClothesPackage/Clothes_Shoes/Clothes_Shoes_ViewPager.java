...
public class Clothes_Shoes_ViewPager extends AppCompatActivity {

    ViewPager viewPager;
    Clothes_Shoes_SwipeAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new Clothes_Shoes_SwipeAdapter(this);
    ...
    public void btnclose(View view)
    {
        ...
        Intent mBackToProductPage = new Intent(this,Clothes_Shoes_Page.class);
    ...
    public  void addDotsIndicator(int position)
    {
        ...
        {
            mDots[i]=new TextView(Clothes_Shoes_ViewPager.this);
