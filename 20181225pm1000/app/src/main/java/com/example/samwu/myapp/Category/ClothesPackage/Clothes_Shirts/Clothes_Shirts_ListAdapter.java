...
public class Clothes_Shirts_ListAdapter extends RecyclerView.Adapter<Clothes_Shirts_ListAdapter.ViewHolder>{

    private Clothes_Shirts_ListAdapter.OnItemClickListener listener;

    public List<getUploadedProductsData> getUploadedProductsData;

    public Clothes_Shirts_ListAdapter(List<getUploadedProductsData> getUploadedProductsData) {
        this.getUploadedProductsData = getUploadedProductsData;

    }

    public Clothes_Shirts_ListAdapter(){}
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Clothes_Shirts_ListAdapter.ViewHolder(view);
    }
