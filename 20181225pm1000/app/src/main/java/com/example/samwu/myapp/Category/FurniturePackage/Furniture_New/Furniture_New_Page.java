...
public class Furniture_New_Page extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mDBProfileimg.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                Picasso.with(Furniture_New_Page.this).load(ProfileImgPath).fit().centerInside().into(prod_image);
            }
        ...
        IntentToViewpager = new Intent(this, Furniture_New_ViewPager.class);
    ...
    private void addfavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(Furniture_New_Page.this, "已加入我的最愛", Toast.LENGTH_LONG).show();
    ...
    private void removefavorite() {
        ...
        favoriteDocumentRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                Toast.makeText(Furniture_New_Page.this, "已移除", Toast.LENGTH_LONG).show();
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    if (!mAuth.getEmail().equals(s)) {
                        ...
                        Intent intent = new Intent(Furniture_New_Page.this, MessageActivity.class);
...
//---ShowBtn
    ...
    {
        Intent detailpage = new Intent(this, Furniture_New_detailpage.class);
