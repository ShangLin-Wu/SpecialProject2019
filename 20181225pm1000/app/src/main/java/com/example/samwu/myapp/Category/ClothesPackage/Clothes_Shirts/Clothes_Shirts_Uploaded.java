...
public class Clothes_Shirts_Uploaded extends AppCompatActivity implements Clothes_Shirts_ListAdapter.OnItemClickListener {

    CollectionReference mDBPath;
    FirebaseFirestore mDB = FirebaseFirestore.getInstance();

    private List<getUploadedProductsData> getUploadedProductsDataList;
    private Clothes_Shirts_ListAdapter ClothesShirtsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clothes__shirts_uploaded);

        getUploadedProductsDataList = new ArrayList<>();

        ClothesShirtsAdapter = new Clothes_Shirts_ListAdapter(getUploadedProductsDataList);
        ...
        firebaseUserSearch();
        mResultList.setAdapter(ClothesShirtsAdapter);
        ClothesShirtsAdapter.setOnItemClickListener(Clothes_Shirts_Uploaded.this);
        UIUtil.hideKeyboard(Clothes_Shirts_Uploaded.this);
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                mDBPath.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@android.support.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @android.support.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        ClothesShirtsAdapter.notifyDataSetChanged();
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(this, Clothes_Shirts_Page.class);
